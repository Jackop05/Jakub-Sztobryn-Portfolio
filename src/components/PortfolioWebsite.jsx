  ...
  return (
    <div>
      <div className='fixed w-screen flex justify-between backdrop-blur-sm px-16 py-8 z-50 text-white'>
        ...
        <div 
          className={`rounded-full border-4 w-10 h-10 flex flex-col justify-center cursor-pointer hover:scale-125 hover:border-[3px] transition-all duration-[300ms]`}
      ...
      <div className="relative w-screen h-[700px] anton">
        ...
        <div className="empty-letter absolute bottom-28 right-16 font-bold text-8xl tracking-widest text-transparent" 
      ...
      <div className='bg-slate-800 text-white py-16 px-8 anton'>
        ...
        <div className='flex justify-center' onClick={redirectToHome}>
          <div style={{ backgroundColor: rgbColor }} className="text-white py-3 px-6 rounded-full hover:bg-opacity-75 transition-all duration-300 cursor-pointer">Email Me</div>
        </div>
      </div>
    </div>
  );
