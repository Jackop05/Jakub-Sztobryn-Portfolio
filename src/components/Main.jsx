...
const Main = () => {
  ...
  return (
    <div id="home" className='main flex flex-col lg:flex-row justify-center items-center lg:gap-[150px] gap-[50px] text-light bg-darker p-4 sm:p-10 lg:py-52 pt-24 lg:mt-0 '>
